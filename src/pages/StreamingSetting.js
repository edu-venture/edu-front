    ...
    <Container>
      ...
      <ContentContainer>
        ...
        <Description>
          ...
          그런 다음 방송 인코더를 다운로드 받고 방송 설정을 해주셔야 하는데{" "}
          <br />
        ...
        <Description>
          ...
          <ol>
            ...
            <li>
              상단 메뉴에서 <strong>파일 &gt; 설정 &gt; 방송</strong>메뉴를
              차례대로 클릭해 주십시오.
            </li>
            <li>
              <string>서버</string>와 <strong>스트림 키</strong>를 입력한 후{" "}
              <strong>[적용] </strong>버튼을 클릭해 주십시오.
            </li>
            <ul>
              <li>
                <strong>서버</strong>: 방송을 송출할 채널의 스트림 정보 URL
              </li>
              <li>
                <strong>스트림 키: 방송을 송출할 채널의 스트림 키</strong>
              </li>
            </ul>
            <img
              src="/img/Group200.png"
              alt="Description"
            ...
            />
            <li>
              <strong>출력</strong> 메뉴를 클릭해 주십시오.
            </li>
            <li>
              일반 채널을 통해 방송을 송출하려는 경우, 다음과 같이 설정한 후{" "}
              <strong>[적용]</strong> 버튼을 클릭해 주십시오.
            </li>
            <img
              src="/img/image5.png"
            ...
            <ul>
              <li>
                <strong>데이터율 제어</strong>의 기본 옵션은 CBR입니다. 방송에서
                LED 또는 화려한 조명을 사용하는 경우, VBR 옵션을 권장합니다.
              </li>
              <li>
                <strong>x264 설정 (공백으로 구분)</strong>에 다음 내용을
                복사하여 입력해 주십시오.
              </li>
              <li>cabac=1 bframes=0 keyint=30 keyint_min=30 scenecut=-1</li>
              <li>
                LL-HLS 채널을 통해 방송을 송출하려는 경우, CPU 사용량을
                veryfast로 설정한 후 <strong>[적용]</strong> 버튼을 클릭해
                주십시오.
              </li>
              <li>
                반드시 x264 설정 중 다음 옵션을 설정된 FPS 값을 기준으로
                변경하여 입력해 주십시오.
              </li>
              <li>{`keyint={FPS} keyint_min={FPS}`}</li>
            </ul>
            <li>
              오디오 탭을 클릭하여 오디오 비트레이트를 설정한 후 [적용] 버튼을
              클릭해 주십시오.
            </li>
            <ul>
              <li>
            ...
            <li>
              <strong>비디오</strong> 메뉴를 클릭하여 해상도와 초당 프레임 수를
              설정한 후 <strong>[적용]</strong> 버튼을 클릭해 주십시오.
            </li>
            <ul>
              <li>다음과 같이 설정할 것을 권장합니다.</li>
              <ul>
                <li>
                  <strong>출력 (조정된) 해상도:</strong> 1920x1080
                </li>
                <li>
                  <strong>공통 FPS 값:</strong> 30
                </li>
              </ul>
            </ul>
            <li>
              소스 목록의 <AddIcon></AddIcon>을 클릭하여 비디오/오디오 입력
              장치를 추가해 주십시오.
            </li>
            <ul>
            ...
            <li>
              <strong>[방송 시작]</strong> 버튼을 클릭해 주십시오.
            </li>
            <ul>
              <li>설정한 Live Station 채널을 통해 방송이 송출됩니다.</li>
              <li>
                <strong>[방송 중단]</strong> 버튼을 클릭하여 방송 송출을 종료할
                수 있습니다.
              </li>
            </ul>
          </ol>
